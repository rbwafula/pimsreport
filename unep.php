                    ...
                    <table class="table table-striped table-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="right">Total days<br/>Past due</th>
                                <th class="right">Expired<br/>Projects</th>
                                <!-- <th class="right">Projects Past Due</th> -->
...
for ($i = 0; $i < $office_count; $i++) {
    ...
    echo '<td class="right">' . number_format($processed_divisiondata[$division]["divisionlisting_office"][$i]['total_days_past_due'], 0, '.', ',') . '</td>';
    ...
    $office_total_days_past_due += $processed_divisiondata[$division]["divisionlisting_office"][$i]['total_days_past_due'];
...
echo '<td class="right">' . number_format($office_total_days_past_due, 0, '.', ',') . '</td>';
...
for ($i = 0; $i < count($processed_divisiondata[$division]["divisionlisting_region"]); $i++) {
    ...
    $region_total_days_past_due += $processed_divisiondata[$division]["divisionlisting_region"][$i]['total_days_past_due'];
...
echo '<td class="right">' . number_format($region_total_days_past_due, 0, '.', ',') . '</td>';
...
echo '<td class="right">' . number_format(($office_total_days_past_due + $region_total_days_past_due), 0, '.', ',') . '</td>';
